...
<script type="text/javascript" src="${basePath}/ttms/product/route_list.js"></script>
			...
			<div class="row page-search">
			 <div class="col-md-12">
				<ul class="list-unstyled list-inline">
					<li>
						<input type="text" id="searchstartState" class="form-control" placeholder="路线起点">
					</li>
					<li>
						<input type="text" id="searchendState" class="form-control" placeholder="路线终点">
					</li> 
